...
const debitPlatform = (amount, category, refs = {}, note = null) =>
  addEntry({ entityType: "platform", entityId: PLATFORM_ID, direction: "debit", amount, category, note, ...refs });
...
async function settleAndPayout({ entityType, entityId, start, end, extraFilter, transactionRef, note, paidBy }) {
  ...
  const payout = await Payout.create({
    ...
    flowDirection: netAmount < 0 ? "recovery" : "payout",
...
module.exports = {
  addEntry, creditSupplier, debitSupplier, creditRider, debitRider, creditPlatform, debitPlatform,

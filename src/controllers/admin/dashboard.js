...
exports.getDashboard = async (req, res) => {
  try {
    ...
    // Rider debts — ledger-driven (purana RiderDebt model deprecated, ab sab LedgerEntry mein hai)
    const unsettledRiderDebts = await LedgerEntry.countDocuments({
      entityType: "rider", category: "rider_guilty_debt", settled: false,
    });

...
const { getDeliverySettings } = require("../../cron/deliverySettingService");
...
//       const deduction  = Math.round((inv.supplierDeduction || 0) * 100) / 100;
//       const netAmount  = Math.round((amount - deduction) * 100) / 100;
...
//       }
//       bulkMap[bulkId].totalDeduction = (bulkMap[bulkId].totalDeduction || 0) + deduction;
//     });

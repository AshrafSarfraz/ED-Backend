...
// // ═══════════════════════════════════════════════════════
// //  BUYER — Payment Dashboard
// //  GET /api/payments/buyer/dashboard
// // ═══════════════════════════════════════════════════════
...
//         isOverdue:      now > new Date(inv.dueDate) && inv.paymentStatus !== "paid",
//       });
//     });
...
// // ═══════════════════════════════════════════════════════
// //  BUYER — Submit Payment Receipt
// //  POST /api/payments/buyer/submit
// //  Body: { invoiceIds: [], totalAmount, note }
// //  File: receiptImage (multipart)
// // ═══════════════════════════════════════════════════════
...
//         success: false,
//         message: "invoiceIds and totalAmount are required",
//       });
//     }
...
// // ═══════════════════════════════════════════════════════
// //  BUYER — Get My Receipts
// //  GET /api/payments/buyer/receipts
// // ═══════════════════════════════════════════════════════
...
// //  GET /api/payments/admin/receipts?status=pending
// // ═══════════════════════════════════════════════════════
...
// //  PUT /api/payments/admin/receipts/:receiptId/approve
// // ═══════════════════════════════════════════════════════

// // 📁 controllers/PaymentController.js
// // ONLY approveReceipt function change karo — baaki sab same rahega
...
//       return res.status(400).json({ success: false, message: "Receipt already processed" });
//     }
...
//     // ─── Sirf buyer invoice paid mark karo ───────────────
//     // Supplier ko release NAHI karna — admin baad mein manually karega
...
//       // ─── Supplier invoice ka status → "paid_by_buyer" ─────
//       // Matlab buyer ne pay kar diya — admin release karega baad mein
...
//           supplierPaymentStatus: "paid_by_buyer", // ← naya status: buyer ne diya, admin release karega
//         });
//       }
//     }
...
//       // suppliersReleased = 0 — kyunki abhi release nahi hua
//       suppliersReleased: 0,
//       totalReleased:     0,
//     });
...
//     res.json({
//       success: true,
//       message: `Payment approved ✅ Buyer invoices marked as paid. Supplier payment pending admin release.`,
//       data: {
//         invoiceCount: buyerInvoices.length,
//         note: "Supplier invoices marked as paid_by_buyer. Use supplier payment screen to release.",
//       },
//     });
//   } catch (err) {
...
// //  PUT /api/payments/admin/receipts/:receiptId/reject
// // ═══════════════════════════════════════════════════════
...
// // ═══════════════════════════════════════════════════════
// //  ADMIN — Buyer Payment Summary
// //  GET /api/payments/admin/buyers
// // ═══════════════════════════════════════════════════════

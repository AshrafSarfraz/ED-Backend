...
// ═══════════════════════════════════════════════════════════
//  BRANCH — Save FCM token (push notifications ke liye)
//  PUT /api/branch/fcm-token
//  Auth: Branch token  |  Body: { fcmToken: "..." }
//
//  Mobile app LOGIN pe aur token REFRESH pe yeh call karti hai.
//  $addToSet use kiya hai — same token dobara add nahi hoga,
//  aur ek manager ke phone + tablet dono ke token save rahenge.
// ═══════════════════════════════════════════════════════════
exports.saveFcmToken = async (req, res) => {
  try {
    ...
    await Branch.findByIdAndUpdate(req.branch._id, {
...
// ═══════════════════════════════════════════════════════════
//  BRANCH — Remove FCM token (LOGOUT pe)
//  DELETE /api/branch/fcm-token
//  Auth: Branch token  |  Body: { fcmToken: "..." }
//
//  Sirf USI device ka token hatata hai — baaki devices pe
//  notifications chalti rehti hain.
// ═══════════════════════════════════════════════════════════

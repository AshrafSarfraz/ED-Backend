...
const ledgerEntrySchema = new mongoose.Schema(
  {
    ...
    category: {
      ...
      enum: [
        ...
        "order_earning_reversal",  // supplier debit  — poora order_earning wapas cancel, return supplier_guilty pe
        "commission_reversal",     // platform debit  — commission wapas cancel, return ho jaye (supplier_guilty YA rider_guilty dono pe)
                                    // (item wapas supplier ke paas ja raha hai — unko is order ka koi paisa nahi milna chahiye)
        "return_penalty",          // supplier debit  — 2%, return supplier_guilty resolve hone pe (upar ke ilawa)

...
const bidSchema = new mongoose.Schema(
  {
    ...
    // Kya supplier ne WAQAI max set ki thi?
    // maxBid ko null nahi rakh sakte — recompute() { maxBid: 1 } pe sort karta
    // hai aur Mongo null ko SABSE PEHLE rakhta hai, yaani bina max wala
    // supplier ghalti se leader ban jata. Isliye alag flag.
    maxBidSet: { type: Boolean, default: false },

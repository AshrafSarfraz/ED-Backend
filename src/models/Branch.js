...
const branchSchema = new mongoose.Schema(
  {
    ...
    //  Array hai kyunki ek manager phone + tablet dono use kar sakta hai.
    //  Mobile app login pe token bhejti hai, logout pe hata deti hai.
    //  Mare hue tokens notificationService khud saaf kar deta hai.
